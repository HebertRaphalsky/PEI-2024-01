 ...
 */
@Component
public class AutFilterConvidado implements Filter {
 ...
 public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
  ...
  boolean permissaoConvidado = jwtUtil.verificaAccesso(token, "CONVIDADO");

  if (nomeUsuario != null && permissaoConvidado) {
